...
//    {
    ...
    display.setCursor(0,0);             // 字体位置(未声明将顺序向下）

    display.print("Temp:");
    display.print(SHT31_Temp);
    display.println("*C");

    display.print("Hum:");
    display.print(SHT31_Hum);
    display.println("%");
